...
function InicioUI({ onResumenClick, onRegistrarPedido, onClientesClick, onRegistrarClienteClick, onLogoutClick}) { 
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);

  const userName = "Karen Yulisa!";
  const userRole = "Auxiliar de Pedidos";
  ...
  const handleMenuItemClick = (item) => {
   ...
   switch (item) {
      ...
      default:
        ...
        alert(`Funcionalidad aún no implementada para: ${item}`);
    }
  };
